...
public class AdminController {
	...
	public ApiResponse generateBusinessKey() {
		...
		apiResponse = new ApiResponse(1, adminServices.generateBusinessKey(), "Success", HttpStatus.OK.value(),
				null);
	...
	public ApiResponse encodePassword(@RequestParam("password") String password) {
		...
		apiResponse = new ApiResponse(1, adminServices.encodePassword(password), "Success",
	...
	private ApiResponse addClient(@RequestBody ApplicationClient client) throws Exception {
		apiResponse = new ApiResponse(1, adminServices.addApplicationClient(client), "Success",
				HttpStatus.OK.value(), null);
	...
	private ApiResponse listClients() throws Exception {
		apiResponse = new ApiResponse(1, adminServices.listAllClients(), "Success", HttpStatus.OK.value(),
				null);
	...
	private ApiResponse getClient(@RequestBody ObjectNode on) throws Exception {
		apiResponse = new ApiResponse(1, adminServices.getOneClient(on.get("clientId").asLong(1001)), "Success",
				HttpStatus.OK.value(), null);
	...
	private ApiResponse resetClientPassword(@RequestBody ObjectNode on) throws Exception {
		apiResponse = new ApiResponse(1,
				adminServices.resetClientPassword(on.get("clientId").asLong(),
						on.get("oldPassword").asText(), on.get("newPassword").asText()),
				"Success", HttpStatus.OK.value(), null);
	...
	private ApiResponse forgotClientPassword(@RequestBody ObjectNode on) throws Exception {
		apiResponse = new ApiResponse(1, adminServices.forgotClientPassword(on.get("clientId").asLong()),
				"Success", HttpStatus.OK.value(), null);
	...
	private ApiResponse addVehicleType(@Valid @RequestBody List<VehicleType> vTypes) throws Exception {
		apiResponse = new ApiResponse(1, adminServices.addVehicleTypes(vTypes), "Success",
				HttpStatus.OK.value(), null);
	...
	private ApiResponse listVehicleTypes() throws Exception {
		apiResponse = new ApiResponse(1, adminServices.listVehicleTypes(), "Success", HttpStatus.OK.value(),
				null);
	...
	private ApiResponse addVehicleCompany(@Valid @RequestBody List<VehicleCompany> vCompanies) throws Exception {
		apiResponse = new ApiResponse(1, adminServices.addVehicleCompanies(vCompanies), "Success",
				HttpStatus.OK.value(), null);
	...
	private ApiResponse updateVehicleCompanies(@Valid @RequestBody List<VehicleCompany> vCompanies)
			throws Exception {
		apiResponse = new ApiResponse(1, adminServices.updateVehicleCompanies(vCompanies), "Success",
				HttpStatus.OK.value(), null);
	...
	private ApiResponse listVehicleCompanies() throws Exception {
		apiResponse = new ApiResponse(1, adminServices.listVehicleCompanies(), "Success", HttpStatus.OK.value(),
				null);
	...
	private ApiResponse addVehicleModel(@Valid @RequestBody List<VehicleModel> vModels) throws Exception {
		apiResponse = new ApiResponse(1, adminServices.addVehicleModels(vModels), "Success",
				HttpStatus.OK.value(), null);
	...
	private ApiResponse updateVehicleModel(@Valid @RequestBody List<VehicleModel> vModels) throws Exception {
		apiResponse = new ApiResponse(1, adminServices.updateVehicleModels(vModels), "Success",
				HttpStatus.OK.value(), null);
	...
	private ApiResponse listVehicleModels() throws Exception {
		apiResponse = new ApiResponse(1, adminServices.listVehicleModels(), "Success", HttpStatus.OK.value(),
				null);
